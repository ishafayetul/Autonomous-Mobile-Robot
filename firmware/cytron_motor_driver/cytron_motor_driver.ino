...
Encoder encoder_fleft(42, 43);
Encoder encoder_fright(45, 44);
Encoder encoder_bleft(46, 47);
...
CytronMD motor1(PWM_DIR, 3, 4); // left front //3,2
CytronMD motor2(PWM_DIR, 5, 6); // right front //5,4
CytronMD motor3(PWM_DIR, 7, 8); // left back // 6,7
CytronMD motor4(PWM_DIR, 9, 10); // right back //9,8
...
void Move_motor(int speed_pwm, CytronMD motor) {
